...
export const SearchIcon = ({ width, height, className }) => (
    ...
    <svg aria-hidden='true' width={width} height={height} className={className} stroke='currentcolor' fill='currentcolor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
