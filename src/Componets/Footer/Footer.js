...
function Footer() {
    return (
        <div className='h-[300px] grid grid-cols-2 items-center justify-center px-10  bg-zinc-800/30  relative w-full '>
            <h1 className='text-red-600 text-[20px] font-[900]'>PHIMVIP</h1>
            <ul className='text-white/70 font-bold text-[14px] leading-10' >
