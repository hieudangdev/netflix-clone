...
function Footer() {
    return (
        <div className='min-h-[300px] grid grid-cols-2 items-center bg-[url("/src/Assets/Images/footerdark.jpg")]  after:absolute after:contents after:inset-0 after:bg-gray-700/60  justify-center px-10   relative w-full ' >
